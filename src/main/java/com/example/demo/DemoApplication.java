    ...
    public CommandLineRunner init(PizzaRepository pizzaRepository) {
        ...
        return args -> {
            if (pizzaRepository.count() == 0) {
                ...
                pizzaRepository.save(new Pizza("MamaMia", 85, "Tomatsås,Ost,Skinka,Räkor"));
                pizzaRepository.save(new Pizza("QuattroStagioni", 100, "Tomatsås,Ost,Skinka,Champinjoner,Räkor,Kronärtskocka"));
